...
공공데이터 ID: **OA-21051** | 제공기관: 서울관광재단 / 스마트관광팀 | 분류: 문화/관광
...
공공데이터 ID: **OA-21050** | 제공기관: 서울관광재단 / 스마트관광팀 | 분류: 문화/관광
...
| source_dataset          | category                      | 공공데이터 ID | 제공기관                           | 분류      |     건수 | 좌표 제공   | 갱신 전략        |
| ----------------------- | ----------------------------- | ------------- | ---------------------------------- | --------- | -------: | ----------- | ---------------- |
| `TbVwRestaurants`       | 서울 관광 음식                | OA-21054      | 서울관광재단 / 스마트관광팀        | 문화/관광 |    1,246 | ❌ (주소만) | upsert           |
| `TbVwNature`            | 서울 관광 자연                | OA-21051      | 서울관광재단 / 스마트관광팀        | 문화/관광 |      148 | ❌          | upsert           |
| `TbVwAttractions`       | 서울 관광명소                 | OA-21050      | 서울관광재단 / 스마트관광팀        | 문화/관광 |      470 | ❌          | upsert           |
| `SearchParkInfoService` | 서울 주요 공원                | OA-394        | 서울시 / 정원도시국 정원도시정책과 | 환경      |      133 | ✅ WGS84    | upsert           |
| `culturalSpaceInfo`     | 서울 문화공간                 | OA-15487      | 서울시 / 문화본부 문화정책과       | 문화/관광 |    1,051 | ✅ WGS84    | upsert (일 1회)  |
| `culturalEventInfo`     | 서울 문화행사                 | OA-15486      | 서울시 / 문화본부 문화정책과       | 문화/관광 |   ~3,904 | ✅ WGS84    | replace (일 1회) |
| `LOCALDATA_072405`      | 서울시 휴게음식점 인허가 정보 | OA-16095      | 서울시 / 디지털도시국 데이터전략과 | 보건      |  ~36,967 | ✅ 변환됨   | replace          |
| `LOCALDATA_072404`      | 서울시 일반음식점 인허가 정보 | OA-16094      | 서울시 / 시민건강국 식품정책과     | 보건      | ~120,649 | ✅ 변환됨   | replace          |
| `OA-13663`              | 서울시 식품위생업소 현황      | OA-13663      | 서울시 / 디지털도시국 데이터전략과 | 보건      |  ~10,018 | ❌ (주소만) | replace          |
| `viewNightSpot`         | 서울시 야경명소 정보          | OA-22579      | 서울시 / 문화본부 문화정책과       | 문화/관광 |       51 | ✅ WGS84    | upsert           |
